const countryOptions = [
  ...
  { value: "Bósnia-Herzegóvina", label: "Bósnia-Herzegóvina" },
  ...
  { value: "Canárias", label: "Canárias" },
  { value: "Cazaquistão", label: "Cazaquistão" },
  { value: "Ceuta e Melilla", label: "Ceuta e Melilla" },
  ...
  { value: "Coréia do Norte", label: "Coréia do Norte" },
  ...
  { value: "Groelândia", label: "Groelândia" },
  ...
  { value: "Ilha de Ascensão", label: "Ilha de Ascensão" },
  { value: "Ilha de Clipperton", label: "Ilha de Clipperton" },
  { value: "Ilha de Man", label: "Ilha de Man" },
  { value: "Ilha Natal", label: "Ilha Natal" },
  { value: "Ilha Pitcairn", label: "Ilha Pitcairn" },
  { value: "Ilha Reunião", label: "Ilha Reunião" },
  { value: "Ilhas Aland", label: "Ilhas Aland" },
  { value: "Ilhas Cayman", label: "Ilhas Cayman" },
  { value: "Ilhas Cocos", label: "Ilhas Cocos" },
  { value: "Ilhas Cook", label: "Ilhas Cook" },
  { value: "Ilhas Faroes", label: "Ilhas Faroes" },
  {
  ...
  { value: "Ilhas Norfolk", label: "Ilhas Norfolk" },
  { value: "Ilhas Salomão", label: "Ilhas Salomão" },
  { value: "Ilhas Seychelles", label: "Ilhas Seychelles" },
  { value: "Ilhas Tokelau", label: "Ilhas Tokelau" },
  { value: "Ilhas Turks e Caicos", label: "Ilhas Turks e Caicos" },
  {
  ...
  { value: "Micronésia", label: "Micronésia" },
  ...
  { value: "Samoa Ocidental", label: "Samoa Ocidental" },
  { value: "San Marino", label: "San Marino" },
  { value: "Santa Helena", label: "Santa Helena" },
  { value: "Santa Lúcia", label: "Santa Lúcia" },
  { value: "São Bartolomeu", label: "São Bartolomeu" },
  { value: "São Cristóvão e Névis", label: "São Cristóvão e Névis" },
  { value: "São Martim", label: "São Martim" },
  ...
  { value: "Sudão do Sul", label: "Sudão do Sul" },
  ...
  { value: "Tristão da Cunha", label: "Tristão da Cunha" },
  { value: "Tunísia", label: "Tunísia" },
  { value: "Turcomenistão", label: "Turcomenistão" },
