      ...
      <div className="question-with-tooltip">
        <label>
          <div className="top-tooltip">
            <div>
              Algum dos seus primos paternos já teve câncer ou algum outro tipo
              de neoplasia?
            </div>
            <div>
              <button
